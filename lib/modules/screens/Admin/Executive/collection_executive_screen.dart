...
class CollectionExecutiveScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => CollectionExecutiveCubit(),
...
class CollectionExecutivePageView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CollectionExecutiveCubit, CollectionExecutiveState>(
          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                  ...
                  itemCount: state.collectionExecutive.length,
                  itemBuilder: (context, index) {
                    final product = state.collectionExecutive[index];
                    return InkWell(
                      onTap: () =>
