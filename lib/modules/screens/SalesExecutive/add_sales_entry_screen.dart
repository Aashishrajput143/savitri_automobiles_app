                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      if (state.selectedTractor != null) ...[
                        ...
                        _buildDetailRow(
                            "Number", state.selectedTractor?["number"] ?? ""),
                        _buildDetailRow(
                            "Price", state.selectedTractor?["price"] ?? ""),
                        _buildDetailRow(
                            "PTO HP", state.selectedTractor?["ptoHP"] ?? ""),
                      ...
                      if (state.isChecked) ...[
                        ...
                        _buildDetailRowWithTextField("Vehicle Age",
                            cubit.exchangeItemController, "Enter Vehicle Age"),
                        _buildDetailRowWithTextField("Vehicle Type",
                            cubit.exchangeItemController, "Enter Vehicle Type"),
                        _buildDetailRowWithTextField(
                            "Vehicle Amount",
                            cubit.exchangeItemController,
                      ...
                      MultiSelectDialogField(
                        ...
                        onConfirm: (results) {
                          context
                              .read<AddSaleCubit>()
                              .updateSelectedEquipments(results.cast<String>());
                        },
                        chipDisplay: MultiSelectChipDisplay(
                          ...
                          chipWidth: MediaQuery.of(context).size.width * 0.32,
                        ),
                      ),
                      ...
                      _buildDetailRowWithTextField("Paid Amount",
