...
class CollectionHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<CollectionHomeCubit, CollectionHomeStates>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: BlocBuilder<CollectionHomeCubit, CollectionHomeStates>(
                builder: (context, state) {
              final cubit = context.read<CollectionHomeCubit>();
              ...
              } else if (state is CollectionHomeLoaded) {
                return WillPopScope(
                  onWillPop: () async {
                    final now = DateTime.now();
                    if (lastBackPressTime == null ||
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              TextButton(
                                onPressed: () {
                                  Navigator.pushNamed(
                                      context, Routes.collectionSalesSeeAll);
                                },
                          ...
                          state.getSalesEntries?.data?.docs?.isNotEmpty ?? false
                              ? ListView.builder(
                                  ...
                                  itemCount: (state.getSalesEntries?.data?.docs
                                          ...
                                          5
                                      ? 5
                                      : state.getSalesEntries?.data?.docs
                                              ?.length ??
                                          0,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              TextButton(
                                onPressed: () {
                                  Navigator.pushNamed(
                                      context, Routes.collectionServiceSeeAll);
                                },
                                child: const Text("See all"),
                              ),
                            ],
